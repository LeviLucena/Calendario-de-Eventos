...
<head>
  ...
  .calendar-container {
    ...
    .event-details {
      ...
      top: 0;
      left: 810px; /* Define a posição à direita do calendário */
      width: 300px;
      padding: 10px;
...
<body>
  <div class="calendar-container">
    ...
    <div id="eventDetails" class="event-details" style="display: none;">
      ...
      <p id="eventTeam"></p>
      <button id="deleteEventButton" class="delete-event-button">Deletar Evento</button>
    </div>
  </div>
  ...
  <div id="eventForm" class="event-form-container" style="display: none;">
    ...
    <button id="createEventButton">Criar</button>
  </div>
  ...
  <script>
    $(document).ready(function() {
      ...
      function showEventForm(date) {
        selectedDate = date; // Armazena a data selecionada na variável
